SEVGI_STRINGS = (
    "O qədər gözəl baxırsan ki, bəzən bütün dünyanın kor olmasını istəyirəm.",
    "Səninlə sonsuzluq, qısacıq bir an kimi keçər",
    "İtirilməyəcək qədər dəyərlisən",
    "Sevgi insanı həyata bağlar. Həyat isə insanı sevgiyə bağlar",
    "Özümü görə biləcəyim ən gözəl güzgü mənə baxan gözlərindir",
    "Ağlımda olduğunun yarısı qədər yanımda olsan heç problem olmayacaq kimi hiss edirəm",
    "Çox gözəl gülümsəyirdi, sevmədən keçə bilmədim.",
    "Sən mənim mahnımsan, hər kəsin dili dönməz.",
    "Səsindəki dincliyi kimsə bilməsin, qısqanaram",
    "Sən mənim səmaya göndərdiyim duamın yer üzündəki cavabısan.",
    "Dünyada heç kimə güvənmə.Çünki Ağ gülün kölgəsi qaradır",
    "Əgər eşq bir seçim olsaydı,bu qədər kəskin bir ağrını kim seçərdi...",
    "Sənin olan hər şeyi, hətta sənsizliyi belə səni xatırlatdığı üçün sevirəm!",
    "Sevmək və sevilmək günəşi iki tərəfdən hiss etməyə bənzər.",
    "Getdin.. və solumda qaldın və nəfəsimdə və sonumda.",
    "Çoxdur sənə sözlərim, ağlıma gəldikcə söyləyirəm, bu fani dünyada gülüm mən sənsiz neyləyim?",
    ...
    "Senin olan her seyi, hetta sensizliyi bele seni xatirlattigi üçün sevirem!",
)
